...
RUN apt-get install php php-common php-mbstring php-xmlrpc php-soap php-gd php-xml php-intl php-mysql php-cli php-ldap php-zip php-curl perl nano -y && apt-get clean
...
RUN echo "download" 
#RUN composer create-project magento/project-community-edition /var/www/html/
...
RUN chmod -R 777 /var/www/magento2/
#RUN chmod -R 777 /var/www/magento2/{pub,var}
# unzip drupal.zip
